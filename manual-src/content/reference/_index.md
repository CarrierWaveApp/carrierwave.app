...
description: "Complete documentation of every Carrier Wave feature"
weight: 3
---

This reference manual documents every feature of Carrier Wave in detail. Use the sidebar to navigate to specific topics.

For a quick introduction, see the [Quick Start](/quickstart/). For conceptual background, see the [Beginner's Guide](/guide/).

## Sections

| Section | Description |
|---------|-------------|
| [Tours & Onboarding](/reference/onboarding/) | First-run setup, intro tour, mini-tours, and the Logger tour with KI5GTR |
| [Logger](/reference/logger/) | QSO entry, session management, commands, equipment tracking, share cards, and video export |
| [Dashboard & Statistics](/reference/dashboard/) | Activity grid, statistics, streaks, conditions, service status, friends on air, and needs dashboard |
| [Logs & Search](/reference/logs-search/) | Query language syntax, filters, QSO detail, and session browsing |
...
| [Spot Monitoring](/reference/spots/) | RBN, POTA, SOTA, WWFF spots, P2P discovery, contact validator, and region aggregation |
...
| [Map View](/reference/map/) | QSO map, azimuthal projection, park boundaries, SOTA pins, WWFF references, grid overlay |
| [WebSDR Integration](/reference/websdr/) | Remote receiver listening, recording, QSY auto-retune, quality monitoring, clip export |
| [Widgets & Live Activity](/reference/widgets/) | Home screen widgets, lock screen widgets, Dynamic Island, Needs widget, and watchOS companion |
